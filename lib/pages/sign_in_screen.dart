...
class _signInState extends State<signIn> {
  ...
  void handleLogin() async{
    var loginResponse = await Provider.of<BluetoothConnection>(context, listen: false).user.login();
                ...
                children: <Widget>[
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: 30, right: 30),
                      ...
                      TextFormField(
                          maxLength: 30,
                          onChanged: (text) {Provider.of<BluetoothConnection>(context, listen: false).user.setLoginEmail(text);},
                  ...
                  TextFormField(
                      obscureText: true,
                      maxLength: 30,
                      onChanged: (text) {Provider.of<BluetoothConnection>(context, listen: false).user.setLoginPass(text);},
                      decoration: InputDecoration(
                          labelText: 'Password',
                          labelStyle: TextStyle(
                            color: Color(0xFF0D67B5),
